    ...
    >
      <div className="header-content">
        ...
        <div className="header-social">
          <motion.a
            href="https://www.linkedin.com/in/yash-darji/"
            target="_blank"
      ...
      >
        ⚠️ <strong>Performance Note:</strong> This app is hosted on a free, low-memory server. API responses may be slow—thank you for your patience!
      </motion.div>
    </motion.header>
  );
};
