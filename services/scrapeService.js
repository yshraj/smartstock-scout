// Old scraper reference: This service is commented out for reference and fallback
// New implementation uses yahoo-finance2 API directly in routes
...
class ScrapeService {
    constructor() {
        ...
        // this.interval = null;
        console.log('ℹ️  ScrapeService disabled - using yahoo-finance2 API instead');
    }
